      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h3 class="welcome-sub-text">Referral Link : </h3>
            <h3 style="width: 200%;"><input type="text" class="form-control" value="<?= base_url('register')?>?refcode=<?= $this->session->userdata('refferCode')?>" disabled></h3>
          </li>
        </ul>
